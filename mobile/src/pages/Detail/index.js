...
export default function Detail() {
    ...
    //Trocar o itens estáticos pela variável incidents - Arrumar as rotas

    function sendMail() {
        MailComposer.composeAsync({
            subject: 'Herói do caso: Cadelinha atropelada',
            recipients: ['lucasvidigal3@gmail.com'],
            body: message
        })
    }

    function sendWhatsapp(){
        Linking.openURL(`whatsapp://send?phone=553198093769&text=${message}`)
    }
